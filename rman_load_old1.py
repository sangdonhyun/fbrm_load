...
output_bytes_per_sec_display"""
    ...
    def set_event(self,ora_dict):
        ...
        if ret == 0:
            self.db.dbInsertList(event_list, table_name)
    ...
    def set_del(self,dict_list,hostname):
        ...
        for ref_val in ref:
            ...
            if diff_2  in diff_list:
                del_list.append(diff_2)
        for del_val in del_list:
            print del_val
            db_key, session_key, session_recid, session_stamp = del_val
            print db_key
    ...
    def main(self):
        # self.check_table()rman_fora_01_20200706153456.tmp
        today = datetime.datetime.now()
        file_list = self.get_data_file()
        file_list = ['E:\\Fleta\\data\\FBRM_RMAN_MV\\rman_fora_01_20200706153456.tmp']
        ...
        for file in file_list:
            ...
            #
            # self.db.dbInsertList(dict_list, tb_name)
            # print 'rman catalog count :',len(dict_list)
            # print 'sleep 2 sec'
            ...
            # #     if live['start_date'] =='2020-06-25':
            # #         print live
            # # print len(live_list)
            # try:
            #     os.remove(file)
            # except:
            #     pass.db.dbInsertList(dict_list, tb_name)
            #
            #
            #
            #
